...
# read image
img1 = io.imread('photoframe1.jpeg')
img2 = io.imread('photoframe2.jpeg')
img3 = io.imread('photoframe3.jpeg')
img = io.imread('santaclaus.jpeg')

# record the coordinates of points
PQSR1 = np.array([[1816, 1165], [1836, 1875], [2586, 1232], [2622, 1839]])
PQSR2 = np.array([[1450, 1060], [1380, 1864], [2702, 1042], [2776, 1866]])
PQSR3 = np.array([[1297, 1173], [1255, 1959], [2385, 1114], [2373, 2020]])
PQSR = np.array([[0, 0], [0, 1536], [2048, 0], [2048, 1536]])

# plot images with ROI
# # =====================================================================================================================
# point = ["P", "Q", "S", "R"]
#
# plt.imshow(img1)
...
# plt.title('photoframe2.jpeg')
# plt.axis('off')
# plt.savefig('task2_labelled2.jpeg')
# plt.clf()
# #
# plt.imshow(img3)
# for i in range(4):
...
# plt.title('santaclaus.jpeg')
# plt.axis('off')
# plt.savefig('task2_labelled4.jpeg')
# plt.clf()
